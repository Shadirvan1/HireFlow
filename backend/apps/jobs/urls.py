...
urlpatterns = [
    ...
    path(
        "my-applications/",
        views.MyApplicationsListView.as_view(),
        name="my-applications-list",
    ),
    path(
        "scheduled-interviews/",
        views.ScheduledInterviewsAPIView.as_view(),
        name="scheduled-interviews",
    ),
    path(
        "interviewers/list/",
        views.InterviewersListView.as_view(),
        name="interviewers-list",
    ),
    path(
        "assign/interviewer/<int:pk>/",
        views.AssignInterviewerView.as_view(),
        name="assign-interviewer",
    ),
    path(
        "hr/candidate/application/<int:pk>/",
        views.CandidateApplicationDetailView.as_view(),
        name="candidate-app-detail",
    ),
    path(
        "submit-score/<int:application_id>/", views.SubmitInterviewScoreView.as_view()
    ),
